...
quant_2012_wege=quantile(grid_2012$WEGE,probs = 0.8,na.rm = T)
quant_2012_we=quantile(grid_2012$WE,probs = 0.8,na.rm = T)
quant_2012_er=quantile(grid_2012$ER,probs = 0.8,na.rm = T)
quant_2012_ri=quantile(grid_2012$Richness,probs = 0.8,na.rm = T)

quant_2022_wege=quantile(grid_2022$WEGE,probs = 0.8,na.rm = T)
quant_2022_we=quantile(grid_2022$WE,probs = 0.8,na.rm = T)
quant_2022_er=quantile(grid_2022$ER,probs = 0.8,na.rm = T)
quant_2022_ri=quantile(grid_2022$Richness,probs = 0.8,na.rm = T)
...
p1 = ggplot()+
  ...
  annotate(geom="text", x=-15702330, y=-8020048, label="WEGE(10th)",size = 2)
...
p2 = ggplot()+
  ...
  #geom_sf(data = tropic_of_capricorn_sf, color = "black", linewidth = 0.5)
  #labs(caption = 'WEGE 9th decile')
  annotate(geom="text", x=-15702330, y=-8020048, label="WEGE(9th)",size = 2)
...
p3 = ggplot()+
  ...
  annotate(geom="text", x=-15702330, y=-8020048, label="WE(10th)",size = 2)
...
p4 = ggplot()+
  ...
  #geom_sf(data = tropic_of_capricorn_sf, color = "black", linewidth = 0.5)
  #labs(caption = 'WE 9th decile')
  annotate(geom="text", x=-15702330, y=-8020048, label="WE(9th)",size = 2)
...
p5 = ggplot()+
  ...
  #geom_sf(data = tropic_of_capricorn_sf, color = "black", linewidth = 0.5)
  #labs(caption = 'WE 9th decile')
  annotate(geom="text", x=-15702330, y=-8020048, label="ER(10th)",size = 2)
...
p6 = ggplot()+
  ...
  #geom_sf(data = tropic_of_capricorn_sf, color = "black", linewidth = 0.5)
  #labs(caption = 'WE 9th decile')
  annotate(geom="text", x=-15702330, y=-8020048, label="ER(9th)",size = 2)
...
p_rich9 = ggplot()+
  ...
  #geom_sf(data = tropic_of_capricorn_sf, color = "black", linewidth = 0.5)
  #labs(caption = 'WE 9th decile')
  annotate(geom="text", x=-15702330, y=-8020048, label="Richness(10th)",size = 2)
...
p_rich8 = ggplot()+
  ...
  #geom_sf(data = tropic_of_capricorn_sf, color = "black", linewidth = 0.5)
  #labs(caption = 'WE 9th decile')
  annotate(geom="text", x=-15702330, y=-8020048, label="Richness(9th)",size = 2)
...
ggsave(plot = grid_mammals,filename = 'grid_mammals_8_9_diffv2_we_wege_May_07.png',width = 5.5,height = 6,dpi = 2000)
...
save(grid_2022,file = 'grid_2022_mammals.Rdata')
...
ggsave(plot = grid_mammals,filename = 'grid_grid_mammals_complete.png',width = 9,height = 7,dpi = 2000)
